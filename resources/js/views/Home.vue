<template>
    <PullToRefresh :on-refresh="refreshAccounts">
        <div class="relative min-h-full px-6 py-8 pb-28">
            ...
            >
                ...
                <div class="mt-5 space-y-2">
                    ...
                    >
                        Add your first two-factor authentication account and
                        keep your verification codes ready whenever you need
                        them.
                    </p>
                </div>
            ...
            <section v-else>
                ...
                >
                    ...
                    <p
                        class="mt-1 max-w-[28ch] text-xs leading-relaxed text-ash"
                    >
                        Nothing matches "{{ search }}". Try searching for
                        another account or email.
                    </p>
